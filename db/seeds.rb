...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'Derivative of pi / (1+ pi) ', 
:answer => '0', 
:false_1 => '1/(n+1)^2', 
:false_2 => 'pi', 
:false_3 => 'n/(n+1)^2', 
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'Derivative of n / (1+n) +2', 
:answer => '1/(n+1)^2', 
:false_1 => 'n', 
:false_2 => 'ln(n)', 
:false_3 => 'n/(n+1)^2', 
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'Derivative of sqroot(1+x) / x', 
:answer => '(-x-2) / (2(x^2)sqroot(x+1))', 
:false_1 => 'ln(1+x)/ln(x)', 
:false_2 => '1+x/(2(x^2sqroot(x+1))', 
:false_3 => '((1+x)/x)^-1/2', 
:question_number => 4)  
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'limit as x approaches 2: (3x^2 -x -10) / (x^2 -4)', 
:answer => '0', 
:false_1 => 'not defined', 
:false_2 => 'infinity', 
:false_3 => '2', 
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'limit as x approaches 3: (5x^2 -8x -13) / (x^2 -5)', 
:answer => '2', 
:false_1 => 'not defined', 
:false_2 => 'infinity', 
:false_3 => '0', 
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'derivative of 3z^(-2) - (1/z)', 
:answer => '(z-6)/(z^3)', 
:false_1 => '1/(z^3)', 
:false_2 => '(z-6)/3(z^2)', 
:false_3 => '(z)/3(z^2)', 
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'limit as x approaches -2: x/(x+2) ', 
:answer => '1/2', 
:false_1 => '1', 
:false_2 => '2', 
:false_3 => 'infinity', 
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'second derivative of tan(2x) ', 
:answer => '8tan(2x)sec^2(2x)', 
:false_1 => '4tan(x)sec^2(x)', 
:false_2 => 'sec^2', 
:false_3 => 'cos(2x)tan(x)', 
:question_number => 10)  
...
:category_id => Category.find_by_name('calculus').id,  
:difficulty => 1, 
:question => 'derivative of (t^2)cos[sqroot(t)] ', 
:answer => '2(t)cos(sqroot(t)) - .5(t^(3/2)sin(sqroot(t)))', 
:false_1 => '2(t)cos(t)', 
:false_2 => '2cos(t)', 
:false_3 => '2sin(t)', 
:question_number => 11)  
